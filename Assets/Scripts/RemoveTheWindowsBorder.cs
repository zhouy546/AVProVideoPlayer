...
public class RemoveTheWindowsBorder : MonoBehaviour
{
    ...
    private void ini()
    {
        ...
        Screen.SetResolution(ValueSheet.jsonBridge.information.screenwidth, ValueSheet.jsonBridge.information.screenheight, false);
    ...
    IEnumerator Setposition()
    {
        ...
        bool result = SetWindowPos(GetForegroundWindow(), 0, ValueSheet.jsonBridge.information.xpos, ValueSheet.jsonBridge.information.ypos, ValueSheet.jsonBridge.information.screenwidth + offset, ValueSheet.jsonBridge.information.screenheight + offset, SWP_SHOWWINDOW);       //设置屏幕大小和位置
    }
